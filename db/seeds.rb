...
Offer.create(name: 'Poudlard', address: 'Alnwick NE66 1NQ, United Kingdom', image: 'https://miro.medium.com/v2/resize:fit:1200/1*g7nlreAAvIeBMGjS9jsRWQ.jpeg', price: 100000 , description: 'Poudlard est un pensionnat pour jeunes sorcières et sorciers dirigé principalement par Albus Dumbledore, considéré comme le plus grand sorcier de sa génération', user: rogue)
Offer.create(name: 'Chateau de Peach', address: '10 Rockefeller Plaza, New York, New York, 10020', image: 'https://nintendoeverything.com/wp-content/uploads/Mario-Bros-Movie-Mushroom-Kingdom.jpg', price: 5500 , description: 'Peach est la princesse du Royaume Champignon, qui est constamment attaquée par Bowser.', user: mario)
Offer.create(name: 'Donjon Rouge', address: 'Stradun 33, 20000, Dubrovnik, Croatia', image: 'https://cdnb.artstation.com/p/assets/images/images/012/370/613/large/steve-lund-castle-color2.jpg?1534439770', price:6000 , description:"Le Donjon Rouge est la puissante forteresse qui se dresse sur la colline d'Aegon à Port-Réal.", user: tyrion)
Offer.create(name: 'Cul-de-Sac', address: '1 Bagshot Row, Matamata 3472, New Zealand', image: 'https://static0.gamerantimages.com/wordpress/wp-content/uploads/2020/12/shire-unreal-engine-4-hobbit-hole-side-view.jpg', price:3000, description: "Ce petit trou localisé au coeur de la Comté, est la résidence de la famille Saquet, Bilbon et Frodon étant les plus connus.", user: frodon)
Offer.create(name: 'Marais de Shrek', address: '30 Rissington Rd, Cheltenham GL54 2AY, United Kingdom', image: 'https://i.redd.it/a0eke43vh7a71.jpg', price:100  , description: "Niché dans les collines des Highlands écossais, le Marais de Shrek est une oasis marécageuse, couverte de mousse et à l'eau trouble… mais surtout l'endroit idéal pour trouver la paix et la tranquillité !", user: fiona)
Offer.create(name: 'Palais de Jabba', address: 'P93, Tataouine, Tunisia', image: 'https://lumiere-a.akamaihd.net/v1/images/image_b3e570b3.jpeg?region=0,64,2413,965', price:20000  , description: "Une forteresse idéale pour malfrats et mafieux souhaitant faire de gros buffets et voir des esclaves danser", user: luke)
Offer.create(name: 'Asgard', address: 'Havnegata 20, 3179 Åsgårdstrand, Norway', image: 'https://miro.medium.com/v2/resize:fit:1400/1*imyiyFPSFuWhI0952bLLPA.png', price:100000  , description: "Royaume paradiasque où vous pourrez vous prélasser éternellement avec dieux et deesses, et ce en compagnie du plus fort des avengers..!", user: thor)
Offer.create(name: 'Novigrad', address: '52466, Novigrad, Croatia', image: 'https://i.redd.it/bfydnw47tf9a1.png', price:1000  , description: "Capital de Velen, où bars à plaisirs et marchands ambulants sont nombres. Engagez aussi des witchers à l'occasion.", user: geralt)
